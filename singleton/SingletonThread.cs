...
namespace singleton
{
    ...
    public class SingletonThread
    {
        ...
        public static SingletonThread GetInstance(string value)
        {
            if (_instance == null)
            {
                // Now, imagine that the program has just been launched.Since there's no Singleton instance yet,
                // multiple threads can simultaneously pass the previous conditional and reach this point almost at the same time.
